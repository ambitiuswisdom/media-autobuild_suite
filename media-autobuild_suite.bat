...
(
    ...
    echo.if [[ -z "${MABS_ORIGINAL_RUSTFLAGS+x}" ]]; then
    echo.    MABS_ORIGINAL_RUSTFLAGS="$RUSTFLAGS"
    echo.fi
    echo.export RUSTFLAGS="${MABS_ORIGINAL_RUSTFLAGS:+$MABS_ORIGINAL_RUSTFLAGS }-C target-cpu=x86-64-v3"
